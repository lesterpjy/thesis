...
\textbf{Observation and design.} $d_y=1$, $d_\xi=1$, and $d_\theta=3$, the three kinetic
parameters $(k_a,k_e,V)$, matching the iDAD~\citep{ivanova2021implicit} and
Klein~\citep{klein2026supercharging} implementations.
