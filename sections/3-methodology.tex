...
criterion becomes a pairwise log likelihood-ratio test~\citep{wald1945sequential}, the
sequential-analysis object used for Bayesian adaptive model discrimination by
\citet{cavagnaro2010adaptive}; its expectation over the generated $y_{t,\mathrm{dom}}$ is
the Kullback-Leibler divergence between the two predictive distributions,
\begin{equation}
\label{eq:kl}
...
forward pass and carries a large fixed adjoint-compilation overhead~\citep{fronk2024stiff,pal2023neural,caldana2025neural}.
