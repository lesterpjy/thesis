...
that motivated it. Because PACE relies on a frozen, one-time proposal, a further
direction is to characterise its robustness under misspecification: under prior or
observation-noise shift, and under a structural model gap of the kind the original
motivation describes, where the trust diagnostics of Chapter~\ref{sec:results} should
double as misspecification detectors.
