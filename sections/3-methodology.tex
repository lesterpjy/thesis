...
Gaussian-linearised information gain, equivalently the Bayesian D-optimal value. The
prior-centring and mode-shift factors omitted from Eq.~\eqref{eq:escape-scale}
...
\end{equation}
and declines as the posterior tightens. This is the same concentration that caused
saturation, now appearing as weight degeneracy: the burden has moved from policy
training to amortized inference. Reliable estimation of the EIG \emph{value} under a
